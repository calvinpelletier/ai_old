...
from ai_old.nn.blocks.mod import UpDoubleConvertibleStyleBlock, \
    DoubleConvertibleStyleBlock


class BlendConvertibleStyleGenerator(Unit):
    def __init__(self,
        output_imsize=128,
        init_imsize=4,
        ...
        # initial
        self.initial = DoubleConvertibleStyleBlock(
            nc[-1],
            nc[-1],
            z_dims,
            norm=norm,
        ...
        for i in range(n_down_up):
            up_blocks.append(UpDoubleConvertibleStyleBlock(
                nc[i+1],
                nc[i],
                z_dims,
                norm=norm,
